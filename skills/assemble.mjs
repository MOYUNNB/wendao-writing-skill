...
const SKILL_META = {
  ...
  version: '1.1.0',
  description:
    '基于苏格拉底接生法的网文/短篇创作引导工具。帮作者想，不帮作者写——通过精准提问帮你想清楚长篇 8 模块（选题/世界观/角色/故事结构/章节/伏笔/收线）或短篇 5 模块（情绪锚点/意象与极简规则/角色短篇版/节拍设计/结尾类型学）。永远不生成正文。',
  category: '创作助手',
  tags: ['网文', '小说', '创作', '苏格拉底', '大纲', '人设', '世界观', '伏笔', '短篇', '知乎体', '微小说', '情绪驱动'],
};
